...
public class OrmAvecJpaHibernateSpringDataConceptsApplication {
	...
	public static void main(String[] args) {
        ...
        // -------------------------------------------------------------------		
		ICatagorieRepository categorieDao = ctx.getBean(ICatagorieRepository.class) ;  // renvoi une instance de ICatagorieRepository
		...
		IProduitRepository produitDao = ctx.getBean(IProduitRepository.class) ; // renvoi une instance de IProduitRepository
		...
		for(Produit p:produits) {
			System.out.println("Des:" + p.getDesignation() + " prix: " + p.getPrix() + " quantité: " + p.getQuantite() + " categorie: " + p.getCateg().getNomCategorie());
		}
